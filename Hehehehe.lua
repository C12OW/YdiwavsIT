--// Fishing Toolkit V6 - Super Fast Mode
--// Fitur: Auto lempar cepat, hanya delay di RFRequestFishingMinigameStarted
...
AutoFishingButton.Size = UDim2.new(1, 0, 1, 0)
...
task.wait(2)
        ...
        -- 🔹 Satu-satunya delay (selama mini game berlangsung)
